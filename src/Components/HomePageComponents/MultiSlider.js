...
const MultiSlider=()=>
{
    ...
    const StartTimer=()=>
    {
        const count_down_date=new Date('May 12, 2022 00:00:00').getTime()
    ...
    return (<>
    <Hidden mdDown="true">
    <Paper className={classes.BoxStyle} style={{marginTop:'0.5%'}}>
        <Grid container direction="row">
          <Grid item md={10} style={{paddingRight:'20px',paddingLeft:'20px',paddingTop:'20px'}}>
          <Box style={{display:'flex'}}>
          <Typography><h3 style={{fontFamily:'initial',color:'#081333'}}>New Products</h3></Typography>
        ...
        <Carousel responsive={responsive} infinite={true}  autoPlay={true} keyBoardControl={true}  swipeable={false}
          draggable={false} ssr={true}  containerClass="carousel-container"  >
          {
