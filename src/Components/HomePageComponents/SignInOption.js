...
const SignInOption=()=>
{
   ...
   <NavLink to="#" style={{textDecoration:'none'}}>     <Button startIcon={<LoginIcon/>} variant="contained" className="SignInClass" style={{background:'#ffca44',width:'250px',textTransform:'capitalize',fontSize:'14px'}}>Sign In</Button></NavLink><br></br>
